...
notify-send -i "/home/username/picPath/lightpic.jpg" \ "MACINTOSH-TERMINAL GREETINGS" \ "Good Day LIGHT\nYou are Welcome Once Again \n Alo Monsieur Lumiere"

h=`date +%H`

if [ $h -lt 12 ];then
	notify-send -i "/home/username/picPath/lightpic.jpg" \ 'LIGHT-U-PC - TERMINAL MSG' \ 'Hi Good Morning Sir Light\nBonjour Monsieur Lumiere\nIt is Nice having you back to Mac-Terminal'
elif [ $h -lt 18 ];then
	notify-send -i "/home/username/picPath/lightpic.jpg" \ 'LIGHT-U-PC - TERMINAL MSG' \ 'Hi Good Afternoon Sir Light\nBon journee Monsieur Lumiere\nIt is Nice having you back to Mac-Terminal'
else
	notify-send -i "/home/username/picPath/lightpic.jpg" \ 'LIGHT-U-PC - TERMINAL MSG' \ 'Hi Good Evening Sir Light\nBonne soiree\nIt is Nice having you back to Mac-Terminal'
fi
...
ANDROID_HOME=/home/username/PathToAndroidFolder/Sdk
